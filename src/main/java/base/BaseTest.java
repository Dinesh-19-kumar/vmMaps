...
public class BaseTest {
	...
	public void beforeTest() {
		...
		extentRep.setSystemInfo("Website", "VmMaps");
		extentRep.setSystemInfo("browser", "Chrome");
		sparkReporter.config().setDocumentTitle("VmMaps Automation Report");
		sparkReporter.config().setReportName("VmMaps Automation by Dinesh");
